          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            {[
              ...
              <button
                key={label}
                type="button"
                className="flex items-center justify-center gap-2.5 h-11 rounded-lg text-sm font-medium text-fg cursor-pointer transition-colors duration-200 hover:bg-white/[0.07] active:scale-[0.98]"
